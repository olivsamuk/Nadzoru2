...
from machine.automaton import StateType
import time
...
###### IS SAFE CONTROLLABLE 5 ######
#g1 = G.state_add('1,N-NB', initial=True, marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g2 = G.state_add('2,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g3 = G.state_add('3,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g4 = G.state_add('4,N,-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g5 = G.state_add('5,N,6,F-NB', marked=False, diagnoser_type=StateType.UNCERTAIN, diagnoser_bad=False)
#g6 = G.state_add('7,F-NB', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=False)
#g7 = G.state_add('8,F-B', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=True)
#g8 = G.state_add('9,F-NB', initial=False, marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=False)
#g9 = G.state_add('10,F-NB', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=False)
#g10 = G.state_add('11,N,9,F-NB', marked=False, diagnoser_type=StateType.UNCERTAIN, diagnoser_bad=False)
#g11 = G.state_add('12,N,10,F-NB', marked=False, diagnoser_type=StateType.UNCERTAIN, diagnoser_bad=False)
#g12 = G.state_add('13,N,14,F-NB', marked=False, diagnoser_type=StateType.UNCERTAIN, diagnoser_bad=False)
#g13 = G.state_add('15,F-NB', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=False)
#g14 = G.state_add('14,F-NB', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=False)
#g15 = G.state_add('16,F-B', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=True)
#c, ob
...
#G.transition_add(g6, g8, ge)
#G.transition_add(g8, g9, ga)
#G.transition_add(g9, g9, gb)
#G.transition_add(g5, g10, ge)
#G.transition_add(g10, g11, ga)
#G.transition_add(g11, g11, gb)
#G.transition_add(g4, g12, gg)
#G.transition_add(g12, g12, gb)
#G.transition_add(g12, g13, ge)
#G.transition_add(g13, g14, ga)
#G.transition_add(g14, g13, ge)
#G.transition_add(g13, g15, gg)
#G.transition_add(g15, g15, ga)
#x = G.is_safe_controllable()
#print(x)
###### IS SAFE CONTROLLABLE 4 ######
#g1 = G.state_add('1,N-NB', initial=True, marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g2 = G.state_add('2,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g3 = G.state_add('3,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g4 = G.state_add('4,N,5,F-NB', marked=False, diagnoser_type=StateType.UNCERTAIN, diagnoser_bad=False)
#g5 = G.state_add('6,F-B', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=True)
#g6 = G.state_add('7,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g7 = G.state_add('8,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#c, ob
#ga = G.event_add('a', False, True)
#gb = G.event_add('b', False, True)
...
#G.transition_add(g4, g5, gg)
#G.transition_add(g5, g5, ge)
#G.transition_add(g1, g6, gg)
#G.transition_add(g6, g1, ge)
#G.transition_add(g6, g7, gb)
#G.transition_add(g7, g4, gc2)

#x = G.is_safe_controllable()
#print(x)

###### IS SAFE CONTROLLABLE 3 ######
#g1 = G.state_add('1,N-NB', initial=True, marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g2 = G.state_add('2,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g3 = G.state_add('3,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g4 = G.state_add('4,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g5 = G.state_add('5,N,6,F-NB', marked=False, diagnoser_type=StateType.UNCERTAIN, diagnoser_bad=False)
#g6 = G.state_add('7,F-NB', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=False)
#g7 = G.state_add('9,F-NB', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=False)
#g8 = G.state_add('8,F-B', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=True)
#c, ob
#ga = G.event_add('a', False, True)
#gb = G.event_add('b', False, True)
...
#G.transition_add(g5, g6, gd1)
#G.transition_add(g5, g7, gd2)
#G.transition_add(g7, g6, gc)
#G.transition_add(g6, g8, gg)
#G.transition_add(g8, g8, ge)

#x = G.is_safe_controllable()
#print(x)

###### IS SAFE CONTROLLABLE 2 ######
#g1 = G.state_add('1,N-NB', initial=True, marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g2 = G.state_add('2,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g3 = G.state_add('3,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g4 = G.state_add('10,N,4,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g5 = G.state_add('5,N,11,N,6,F-NB', marked=False, diagnoser_type=StateType.UNCERTAIN, diagnoser_bad=False)
#g6 = G.state_add('7,F-NB', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=False)
#g7 = G.state_add('8,F-B', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=True)
#g8 = G.state_add('12,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#g9 = G.state_add('9,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#c, ob
#ga = G.event_add('a', False, True)
#gb = G.event_add('b', False, True)
#gc = G.event_add('c', True, True)
...
#G.transition_add(g9, g4, gb)
#G.transition_add(g5, g8, gg)
#G.transition_add(g8, g8, gb)


#print(G.is_safe_controllable())
###### IS SAFE CONTROLLABLE 1 ######
# g1 = G.state_add('1,N-NB', initial=True, marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
# g2 = G.state_add('2,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
# g3 = G.state_add('3,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
# g4 = G.state_add('4,N,5,F-NB', marked=False, diagnoser_type=StateType.UNCERTAIN, diagnoser_bad=False)
# g5 = G.state_add('6,F-NB', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=False)
# g6 = G.state_add('7,F-B', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=True)
# g7 = G.state_add('8,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
# g8 = G.state_add('9,N,10,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
# g9 = G.state_add('4,N,5,F,11,N-NB', marked=False, diagnoser_type=StateType.UNCERTAIN, diagnoser_bad=False)
# g10 = G.state_add('12,N-NB', marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
# #c, ob
# ga = G.event_add('a', False, True)
# gb = G.event_add('b', False, True)
# gc = G.event_add('c', True, True)
...
# G.transition_add(g8, g9, ge)
# G.transition_add(g9, g10, gg)
...
#g1 = G.state_add('1', initial=True, marked=False, diagnoser_type=StateType.NEUTRAL, diagnoser_bad=False)
#g2 = G.state_add('2', marked=False, diagnoser_type=StateType.NEUTRAL, diagnoser_bad=False)
#g3 = G.state_add('3', marked=False, diagnoser_type=StateType.NEUTRAL, diagnoser_bad=False)
#g4 = G.state_add('4', marked=False, diagnoser_type=StateType.NEUTRAL, diagnoser_bad=False)
#g5 = G.state_add('5', marked=False, diagnoser_type=StateType.NEUTRAL, diagnoser_bad=False)
#g6 = G.state_add('6', marked=False, diagnoser_type=StateType.NEUTRAL, diagnoser_bad=False)
#g7 = G.state_add('7', marked=False, diagnoser_type=StateType.NEUTRAL, diagnoser_bad=False)
...
#G.transition_add(g1, g2, ga)
#G.transition_add(g2, g3, ge)
#G.transition_add(g2, g4, gc)
#G.transition_add(g3, g5, gf)
#G.transition_add(g4, g6, ga)
#G.transition_add(g5, g7, gc)
#G.transition_add(g6, g6, gb)
#G.transition_add(g7, g7, gd)

#r1 = R.state_add('N-NB', initial=True, marked=False, diagnoser_type=StateType.NORMAL, diagnoser_bad=False)
#r2 = R.state_add('F-NB', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=False)
#r3 = R.state_add('F-B', marked=False, diagnoser_type=StateType.CERTAIN, diagnoser_bad=True)

#ra = R.event_add('a', False, True)
#rb = R.event_add('b', False, True)
#rc = R.event_add('c', False, True)
#rd = R.event_add('d', False, True)
#re = R.event_add('e', False, True)
#rf = R.event_add('f', False, False)

#R.transition_add(r1, r2, rf)
#R.transition_add(r2, r3, rb)
#R.transition_add(r1, r1, ra)
#R.transition_add(r1, r1, rb)
#R.transition_add(r1, r1, rc)
#R.transition_add(r1, r1, rd)
#R.transition_add(r1, r1, re)
#R.transition_add(r2, r2, ra)
#R.transition_add(r2, r2, rc)
#R.transition_add(r2, r2, rd)
#R.transition_add(r2, r2, re)
#R.transition_add(r2, r2, rf)
#R.transition_add(r3, r3, rf)
#R.transition_add(r3, r3, ra)
#R.transition_add(r3, r3, rb)
#R.transition_add(r3, r3, rc)
#R.transition_add(r3, r3, rd)
#R.transition_add(r3, r3, re)
...
#G.string_detector()
#S = G.synchronization(G.labeller(fault_events)).observer()
#print(S)
